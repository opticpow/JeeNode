...
#define DHT22_PORT  1   // defined if DHT22 is connected to a port
...
#define MEASURE_PERIOD  60 // how often to measure, in tenths of seconds (Default 600)
...
static void doMeasure() {
    ...
    int chk = dht22.read22();
      ...
      Serial.print("DHT22: ");
      Serial.print((float)dht22.temperature);
      Serial.print("C ");
      Serial.print((float)dht22.humidity);
      Serial.print("%\n");
    #endif
    //int humi = dht22.humidity + 0.5, temp = 10 * temp_tmp102 + 0.5;
    int humi = dht22.humidity + 0.5, temp = 10 * dht22.temperature + 0.5;
  #endif
